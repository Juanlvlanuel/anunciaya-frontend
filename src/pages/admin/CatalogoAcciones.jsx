  ...
  return (
    <button
      ...
      className={`w-8 h-8 mx-auto rounded-md border transition transform active:scale-95
        ${disabled ? "opacity-60 cursor-not-allowed" : "hover:shadow-sm hover:bg-gray-50 dark:hover:bg-zinc-800"}`}
      aria-label={aria}
      title={aria}
...
export default function CatalogoAcciones() {
  ...
  }, [currentRoleAbilities, currentFeaturesByPlan]);
                    ...
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <div className="flex gap-1">
                        <SmallBtn
                          ...
                          onClick={() => setColAbilities(r, true)}
                        >✓</SmallBtn>
                        <SmallBtn
                          title={`Desmarcar todas las acciones para ${r}`}
                          onClick={() => setColAbilities(r, false)}
                        >–</SmallBtn>
                        <SmallBtn
                          title={`Invertir selección de ${r}`}
                          onClick={() => invertColAbilities(r)}
                        >↔</SmallBtn>
                      </div>
                    </div>
                  </th>
