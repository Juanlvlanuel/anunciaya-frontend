    ...
    return (
      <div className="space-y-3">
        ...
        <button
          ...
          className="text-sm px-3 py-1.5 rounded-xl border hover:bg-gray-50 dark:hover:bg-zinc-800"
        >
          Reintentar
        </button>
      </div>
          ...
          <li key={s.id || s._id} className="py-2 flex items-center justify-between">
            <div className="text-sm">
              <div className="font-medium flex items-center gap-2">
                ...
                {s.current ? (
                  <span className="text-xs px-2 py-0.5 rounded-full bg-blue-50 text-blue-700 border border-blue-200 dark:bg-blue-900/20 dark:text-blue-300 dark:border-blue-900/40">
                    Actual
                  </span>
                ) : null}
              </div>
