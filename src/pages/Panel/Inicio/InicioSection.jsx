    ...
    <div className="p-5 sm:p-6 lg:p-8 space-y-6">
      ...
      <div className="rounded-2xl border border-black/5 bg-white shadow-sm p-5">
        ...
        <div className="grid grid-cols-3 gap-3">
          <button onClick={goNuevoCupon} className="rounded-2xl border border-black/5 bg-white shadow-sm p-4 text-sm font-medium hover:scale-[1.02] active:scale-[0.98] transition">Crear cupón</button>
