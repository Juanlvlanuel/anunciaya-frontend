  ...
  return (
    <div ref={wrapRef} className="relative right-2">
      ...
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 shadow-[4px_4px_8px_rgba(0,0,0,0.15),-4px_-4px_8px_rgba(255,255,255,0.8)] hover:shadow-[2px_2px_4px_rgba(0,0,0,0.2),-2px_-2px_4px_rgba(255,255,255,0.7)] active:scale-[0.95] focus:outline-none"
      >
        <FaBars size={18} className="text-[#4B555C]" />
      </button>
      ...
      {open && (
        <div
          ...
          style={{ right: "-11px" }}   // mueve 20px más a la derecha
        >
            ...
            {categorias.map((c) => (
              ...
              >
                <img
                  src={c.icon}
                  alt={c.label}
                  className="w-9 h-9 object-contain transition-transform duration-150 hover:scale-110"
                  draggable="false"
                />
