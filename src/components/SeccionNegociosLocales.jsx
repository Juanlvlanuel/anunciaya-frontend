...
import { categoriasNegociosLocales } from "../data/categoriasNegociosLocales";

export default function SeccionNegociosLocales({
  ...
  return (
    <section className="w-full">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 xl:grid-cols-6 gap-3">
        {categoriasNegociosLocales.map(({ nombre, icono: Icono, to }) => (
          <button
            key={nombre}
            onClick={() => navigate(to)}
